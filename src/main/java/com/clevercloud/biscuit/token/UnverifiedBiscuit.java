...
public class UnverifiedBiscuit {
    ...
    static public UnverifiedBiscuit from_bytes_with_symbols(byte[] data, SymbolTable symbols) throws Error {
        ...
        return UnverifiedBiscuit.from_serialize_biscuit(ser, symbols);
    }
     ...
     * @return UnverifiedBiscuit
     */
    static private UnverifiedBiscuit from_serialize_biscuit(SerializedBiscuit ser, SymbolTable symbols) throws Error {
     ...
     * @return
     */
    public UnverifiedBiscuit attenuate(final SecureRandom rng, final KeyPair keypair, Block block) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, Error {
    ...
    public UnverifiedBiscuit copy() throws Error, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
